...
public class DeletePerson {
    public void deleteChild (String codiceFiscale) throws SQLException {
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mydb");
        Statement stmt = conn.createStatement();
        int i = stmt.executeUpdate("DELETE * FROM BAMBINI WHERE CODICE FISCALE = '"+codiceFiscale+"'");

    }
    public void deleteParent (String codicefiscale) throws SQLException {
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mydb");
        Statement stmt = conn.createStatement();
    ...
    public void deletePerson (String table, String codiceFiscale) throws SQLException {
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mydb");
        Statement stmt = conn.createStatement();
